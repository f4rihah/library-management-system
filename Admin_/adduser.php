...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
    <h2 style="color:black; font-family: Lucida Console; text-align: center"><b>Add New User</b></h2>
    ...
    <form class="user" action="" method="post">
        ...
        <input type="text" name="roll" class="form-control" placeholder="Roll" required=""><br>
...
<?php
    if(isset($_POST['submit']))
    {
      ...
      {
        mysqli_query($db,"INSERT INTO student VALUES ('$_POST[first]', '$_POST[last]', '$_POST[username]', '$_POST[password]', '$_POST[roll]', '$_POST[email]', '$_POST[contact]', '$_POST[pic]') ;");
        ?>
